...
class CompareTuple:
    ...
    def __le__(self, other:object) -> bool:
        """
        Returns True if the version of the self object is lower than or equal to the version of the other object.
        """ 
        return (self.packfull<other) | (self.packfull==other)
   
    def __gt__(self, other:object) -> bool:
        """
        Returns True if the version of the self object is greater than the version of the other object.
        """ 
        other = CompareTuple(other)
        if self.OK and other.OK:
            if self.getPackname==other.getPackname:
    ...
    def __ge__(self, other:object) -> bool:
        """
        Returns True if the version of the self object is greater than or equal to the version of the other object.
        """ 
        return (self.packfull>other) | (self.packfull==other)

    def __ne__(self, other:object) -> bool:
        """
        Returns True if the version of the self object is not equal to the version of the other object.
        """ 
        return not(self.packfull==other)
